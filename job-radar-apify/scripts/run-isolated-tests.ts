...
const suites: Record<string, string[]> = {
  unit: ["validate-test-safety.test.ts", "validate-dashboard-filters.ts", "validate-role-matching.ts", "validate-run-telemetry.test.ts", "validate-fetch-context.test.ts", "validate-source-contract.test.ts"],
